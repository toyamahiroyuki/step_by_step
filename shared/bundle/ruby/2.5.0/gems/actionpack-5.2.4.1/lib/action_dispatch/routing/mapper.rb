...
module ActionDispatch
  module Routing
    class Mapper
      ...
      class Mapping #:nodoc:
        ANCHOR_CHARACTERS_REGEX = %r{\A(\\A|\^)|(\\Z|\\z|\$)\Z}.freeze
      ...
      module CustomUrls
        ...
        def direct(name, options = {}, &block)
          unless @scope.root?
            raise "The direct method can't be used inside a routes scope block"
          end
        ...
        def resolve(*args, &block)
          unless @scope.root?
            raise "The resolve method can't be used inside a routes scope block"
          end
