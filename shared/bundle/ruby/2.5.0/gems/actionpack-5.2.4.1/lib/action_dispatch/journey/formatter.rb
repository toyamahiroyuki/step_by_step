  ...
  module Journey
    ...
    class Formatter
      ...
      def generate(name, options, path_parameters, parameterize = nil)
        ...
        message << ", missing required keys: #{missing_keys.sort.inspect}" if missing_keys.present?
        message << ", possible unmatched constraints: #{unmatched_keys.sort.inspect}" if unmatched_keys.present?
      ...
      module RegexCaseComparator
        DEFAULT_INPUT = /[-_.a-zA-Z0-9]+\/[-_.a-zA-Z0-9]+/.freeze
