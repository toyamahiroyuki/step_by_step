  ...
  module XML
    ...
    class Node
      ...
      def add_previous_sibling(node_or_tags)
        raise ArgumentError, "A document may not have multiple root nodes." if (parent && parent.document?) && !(node_or_tags.comment? || node_or_tags.processing_instruction?)
      ...
      def parse(string_or_io, options = nil)
        ...
        if node_set.empty? && (document.errors.length > error_count) && options.recover?
      ...
      def namespaces
        Hash[namespace_scopes.map do |nd|
